...
function projects_createLayout() {
    return ""
        ...
        + "    <div class='content'>"
        + "      <ul class='connectedSortable sortable' style='width:100%; height:100%;' id='ULROOT'>"
        + "        <li id='item0' class='ui-state-highlight'><div>Item 0</div><ul class='connectedSortable sortable' id='ulitem0'></ul></li>"
        + "        <li id='item1' class='ui-state-highlight'><div>Item 1</div><ul class='connectedSortable sortable' id='ulitem1'></ul></li>"
        + "        <li id='item2' class='ui-state-highlight'><div>Item 2</div><ul class='connectedSortable sortable' id='ulitem2'></ul></li>"
        + "        <li id='item3' class='ui-state-highlight'><div>Item 3</div><ul class='connectedSortable sortable' id='ulitem3'></ul></li>"
        + "        <li id='item4' class='ui-state-highlight'><div>Item 4</div><ul class='connectedSortable sortable' id='ulitem4'></ul></li>"
        + "        <li id='item5' class='ui-state-highlight'><div>Item 5</div><ul class='connectedSortable sortable' id='ulitem5'></ul></li>"
        + "      </ul>"
        + "    </div>"
        + "  </div>"
...
function projects_refresh_sortable() {
    hirachy = $(".project_hirachy .content .sortable").sortable({
        ...
        receive: function (event, ui) {
            ...
            console.log($(this).data()['ui-sortable']);
