...
function projects_createLayout() {
    return ""
        ...
        + "        <li id='item1' class='ui-state-highlight'><div>Item 0</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li id='item2' class='ui-state-highlight'><div>Item 1</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li id='item3' class='ui-state-highlight'><div>Item 2</div><ul class='connectedSortable sortable'></ul></li>"
        + "      </ul>"
        + "    </div>"
        + "  </div>"
