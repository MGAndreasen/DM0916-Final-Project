...
function projects_createLayout() {
    return ""
        ...
        + "        <li class='ui-state-highlight'><div>Item 3</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li class='ui-state-highlight'><div>Item 4</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li class='ui-state-highlight'><div>Item 5</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li class='ui-state-highlight'><div>Item 6</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li class='ui-state-highlight'><div>Item 7</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li class='ui-state-highlight'><div>Item 8</div><ul class='connectedSortable sortable'></ul></li>"
        + "        <li class='ui-state-highlight'><div>Item 9</div><ul class='connectedSortable sortable'></ul></li>"
        + "      </ul>"
        + "    </div>"
        + "  </div>"
