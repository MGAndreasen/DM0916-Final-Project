 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'SomeLameAssTokenThatNoOneCanRememberOnTopOfThereHeadOrSoIJustHopeTheyCantButInCaseTheyCanIWillJustAddThisLittleSign!AtTheEnd');
 ...
 */
define('TARGET_DIR', '/tmp/DM0916-Final-Project/');
